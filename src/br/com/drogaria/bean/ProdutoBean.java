...
@ManagedBean(name = "MBProduto") // É O NOME QUE EU USO NO XHTML
@ViewScoped
public class ProdutoBean {
	...
	public void novo() {
		...
		JSFUtil.adicionarMensagemSucesso("Produto salvo.");
	}
	...
	public void excluir() {
		...
		try {
			...
			JSFUtil.adicionarMensagemSucesso("Produto removido.");
